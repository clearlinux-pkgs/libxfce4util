...
Source0  : https://archive.xfce.org/src/xfce/libxfce4util/4.18/libxfce4util-4.18.2.tar.bz2
...
%prep
%setup -q -n libxfce4util-4.18.2
cd %{_builddir}/libxfce4util-4.18.2
%patch -P 1 -p1
pushd ..
cp -a libxfce4util-4.18.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707233184
