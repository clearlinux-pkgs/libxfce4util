...
Source0  : http://archive.xfce.org/src/xfce/libxfce4util/4.15/libxfce4util-4.15.4.tar.bz2
...
%prep
%setup -q -n libxfce4util-4.15.4
cd %{_builddir}/libxfce4util-4.15.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604509732
...
cp %{_builddir}/libxfce4util-4.15.4/COPYING %{buildroot}/usr/share/package-licenses/libxfce4util/83ba6546e00f890f3a26a9bedd264084f8527d5e
%make_install
